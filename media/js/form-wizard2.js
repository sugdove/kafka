        ...
        init: function () {
                    ...
                    form.validate({
                        ...
                        rules: {
                            ...
                            msg: {
                                ...
                                required: true,
                                remote: {
                                    url: "http://" + localhost + "/VirtualizationUnifiedBackup/strategyIsExist",
                                    type: "post",
                                    dataType: "json",
                                    data: {
                                        str: function () {
            ...
            $('#form_wizard_1').bootstrapWizard({
                ...
                //第一界面点击下一步时获取topic
                         ...
                         var param_ = {HBaseTable:tableName,zookeeper:zookeeper,znode:znode,serviceId:serviceId};
                         var param = JSON.stringify(param_);
                        $.ajax({
                            url: "http://" + localhost + "/longGangKafka/getDefaultTopic",
                            cache: true,
                            data:{param:param},
                            type: "post",
                            async: false,
